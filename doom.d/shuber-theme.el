;;; shuber-theme.el --- shuber's preferences -*- lexical-binding: t; -*-

(require 'doom-themes)

(defgroup doom-shuber-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-shuber-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-shuber-theme
  :type '(choice integer boolean))

(def-doom-theme doom-shuber
  ...
  ((bg         '("#1d1f21" nil       nil          ))
   ...
   (-modeline-pad
    (when doom-shuber-padded-modeline
      (if (integerp doom-shuber-padded-modeline)
          doom-shuber-padded-modeline
        4))))
...
(provide 'doom-shuber-theme)
;;; doom-shuber-theme.el ends here
