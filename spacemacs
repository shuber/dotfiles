...
you should place your code here."
  ...
  (define-key evil-normal-state-map (kbd ",v") 'split-window-right-and-focus)

  ;; Keybindings for window/split movements
  (define-key evil-normal-state-map (kbd "C-j") 'other-window)
  (define-key evil-normal-state-map (kbd "C-k") 'prev-window)
